...
export const userSchema = z.object({
  ...
  profession: z.string().min(3, "Profession must be at least 3 characters long"),
  avatar: z.instanceof(File, { message: "Please select a valid file" }).optional(),
  password: z.string().min(8, "Password must be at least 8 characters long"),
});

type FormErrors = z.inferFlattenedErrors<typeof userSchema>["fieldErrors"];
...
export function SignupForm({ className, ...props }: React.ComponentProps<"div">) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      formData.append("education", result.data.education);
      formData.append("profession", result.data.profession);
      formData.append("password", result.data.password);

      if (result.data.avatar) {
        formData.append("avatar", result.data.avatar);
      }
        ...
        <CardContent className="grid p-0 md:grid-cols-2">
          <form className="p-6 md:p-8" onSubmit={handleSubmit}>
            <FieldGroup>
              ...
              <Field className="md:grid grid-cols-2 gap-4">
                <Field>
              ...
              <Field className="md:grid grid-cols-2 gap-4">
                <Field>
                  ...
                  />
                  <FieldError>{errors?.education?.[0]}</FieldError>
                </Field>
                <Field>
                  ...
                  />
                  <FieldError>{errors?.profession?.[0]}</FieldError>
                </Field>
              </Field>
